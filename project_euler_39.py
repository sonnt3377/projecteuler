...
def find_number_of_solutions(perimeter):
    """
    Find the number of solutions for certain value of the perimeter

    :param perimeter: perimeter of the right triangle
...
# From 1, a = p - b - c, replace in 3, then b^2 + c^2 = (p - b - c)^2
#                                                     = p^2 + b^2 + c^2 - 2bp - 2cp + 2bc
